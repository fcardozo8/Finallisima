...
class TestCompleto {
	...
	void testBasicoArtirta() {
		try {
			//Datos: Julio Iglesias	23/09/43 (78 años)-Masculino
	...
	void testAddArtistaAGestor() {
		try {
//			Datos:
//			Julio Iglesias			23/09/43 (78 años)-Masculino
//			Celine M. C. Dion		30/03/68 (54 años)-Femenino
//			Madonna L. V. Ciccone	16/08/58 (63 años)-Femenino
			...
			assertEquals(false,ga.addArtista(a3));		//No carga duplicados
			assertEquals(false,ga.addArtista(a2));		//No carga duplicados
...
//		Luis Miguel	30/03/90 (32 años)-Masculino
//		Laura		16/08/88 (33 años)-Femenino
//		Lucia		16/08/87 (34 años)-Femenino
		GestorArtista ga = GestorArtista.getInstancia();
...
//		Lucia		16/08/87 (34 años)-Femenino
		...
		ArrayList<Artista> aux = ga.getArtistasImplementarConLambda(32);
...
//		Datos: Luis Paez	23/09/90 (31 años)-Masculino
		GregorianCalendar f1 = new GregorianCalendar();
		f1.set(1990, 8, 23);
		try {
			Artista a1 = new Artista ("luis Paez",f1,Sexo.Masculino);
...
//		Datos: Luis Paez	01/07/04 (18 años)-Masculino
		GregorianCalendar f2 = new GregorianCalendar();
		f2.set(2004, 6, 1);
		try {
...
//		Datos: Luis Paez	10/07/04 (17 años)-Masculino
		GregorianCalendar f3 = new GregorianCalendar();
		f3.set(2004, 8, 10);
		try {
...
//		Datos: Luis Paez	10/10/06 (15 años)-Masculino
		GregorianCalendar f4 = new GregorianCalendar();
		f4.set(2006, 9, 1);
		try {
